...
<body>
    ...
    <form id="loginform" method="post" style="text-align:left; background:inherit; margin:0; border:0;" runat="server"> 
		<div class="auth" 
            ...
            style="border-style: none; border-color: inherit; border-width: 0; background: #fff url('images/white.jpg')  right top; width:306px; height:500px; margin:0">
		<div style="padding:10px 0 0 5px; width: 299px;">
                ...
                &nbsp;
                <asp:Label ID="Label2" runat="server" Text="Assassin’s Creed IV Black Flag" 
                    CssClass="style1"></asp:Label>
						<br/>
						<br/>
					<asp:Label ID="Label6" runat="server" Text="Price:" CssClass="style1"></asp:Label>
&nbsp;
                <asp:Label ID="Label7" runat="server" Text="29,99" CssClass="style1"></asp:Label>
