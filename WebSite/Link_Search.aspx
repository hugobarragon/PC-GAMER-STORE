...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<link rel="stylesheet" href="search-Bar/style.css" type="text/css" />
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,700italic,400,600,700' rel='stylesheet' type='text/css'>
	<script type="text/javascript" src="search-Bar/js/jquery-1.7.1.min.js"></script>
	<script type="text/javascript" src="search-Bar/js/jquery.easing.1.3.js"></script>
	<script type="text/javascript" src="search-Bar/js/functions.js"></script>
...
&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="30px" 
                    ImageUrl="~/Base Dados/Imagem-Site-Pc-Gamer/Search-icon.png" Width="30px" />
                <br />
                <br />
...
<SortedDescendingHeaderStyle BackColor="#242121"></SortedDescendingHeaderStyle>
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [Name], [Developer], [Price], [Release Date] AS Release_Date, [Imagem], [Link], [Category] FROM [Ver_todos] WHERE ([Name] LIKE '%' + ? + '%')">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="TextBox1" DefaultValue="a" Name="Name" 
