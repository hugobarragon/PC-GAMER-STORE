        ...
        <tr>
            <td style="text-align: left">
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
                    ...
                    DataSourceID="AccessDataSource2" ForeColor="Black" GridLines="Horizontal" 
                    CellSpacing="5" HorizontalAlign="Center">
                    <Columns>
                        <asp:ImageField DataImageUrlField="Imagem" HeaderText="Imagens">
                        ...
                        <asp:HyperLinkField HeaderText="View Details" 
                            Text="Details" DataNavigateUrlFields="Link" />
                    </Columns>
                ...
                <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT [Imagem], [Name], [Developer], [Price], [Release Date] AS Release_Date, [Link] FROM [Action]">
                </asp:AccessDataSource>
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    DataFile="~/Base Dados/Database-PC-Gamer.accdb" 
                    SelectCommand="SELECT [Imagem], [Name], [Developer], [Release Date] AS Release_Date, [Price] FROM [Action]">
                </asp:AccessDataSource>
            </td>
        </tr>
    </table>
